...
import {
  ...
  getUserSubscription,
} from './../common/util/PushNotifications';
...
export default function usePushNotifications(): any {
   ...
   */
  const onClickSendSubscriptionToPushServer = (): void => {
    setLoading(true);
    setError(false);
    axios
      .post<any, any>('/subscription', userSubscription)
